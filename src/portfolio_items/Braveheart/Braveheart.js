                    ...
                    <div className="portfolioPopup_bg">
                        <div className="portfolioPopup_content">
                            ...
                            <div style={{overflow: "hidden"}}>
                                <img style={{width: "min(100%, 680px)"}} className="portfolioPopup_description_imgRight" src={require("./bh1.gif")}/>
                                <p className="portfolioPopup_description_text">{text.desc1}</p>
                            </div>
                            <div style={{overflow: "hidden"}}>
                                <img style={{width: "min(100%, 680px)"}} className="portfolioPopup_description_imgLeft" src={require("./bh2.gif")}/>
                                <p style={{marginTop: "1.5%"}} className="portfolioPopup_description_text">{text.desc2} </p>
                            </div>
                            <div style={{display: "flex", justifyContent: "center", marginTop: "2%"}}>
                                <img style={{width: "min(100%, 690px)", marginBottom: "2%"}} src={require("./bh3.gif")}/>
                            </div>
